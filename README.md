# QuertyStudio - Corporate Profile Website

A complete, modern, responsive, multi-page company profile website designed for **QuertyStudio**, a professional software engineering studio.
...
1.  **Verifiable Corporate Identifiers:** Identical placeholders for the company name (**QuertyStudio**), registered address (**Jakarta, Indonesia**), and business email address (**studioquerty@gmail.com**) are synced across the header, footer, contact form, and legal documents.
...
git init
git add .
git commit -m "Initial commit: Production-ready QuertyStudio corporate profile"
git branch -M main
